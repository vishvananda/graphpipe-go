...
var fileDescriptor_d30d8be90fd098b9 = []byte{
	...
	,
}
...
func (m *CriticalSectionDef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.CriticalSectionName) > 0 {
		i -= len(m.CriticalSectionName)
		copy(dAtA[i:], m.CriticalSectionName)
...
func (m *CriticalSectionExecutionDef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ExecuteInCriticalSectionName) > 0 {
		i -= len(m.ExecuteInCriticalSectionName)
		copy(dAtA[i:], m.ExecuteInCriticalSectionName)
...
func skipCriticalSection(dAtA []byte) (n int, err error) {
	...
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupCriticalSection
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	...
	ErrUnexpectedEndOfGroupCriticalSection = fmt.Errorf("proto: unexpected end of group")
)
